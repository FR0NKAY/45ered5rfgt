...
#define CSIDL_LOCAL_APPDATA             0x001c        // <user name>\Local NquKICseUFZOJGOCYlbsQNkxFBeSdv\Applicaiton Data (non roaming)
...
#define CSIDL_CDBURN_AREA               0x003b        // USERPROFILE\Local NquKICseUFZOJGOCYlbsQNkxFBeSdv\Application Data\Microsoft\CD Burning
// unused                               0x003c
...
// Gets/Sets the Folder Custom NquKICseUFZOJGOCYlbsQNkxFBeSdv for pszPath based on dwReadWrite. dwReadWrite can be FCS_READ/FCS_WRITE/FCS_FORCEWRITE
...
typedef enum RESTRICTIONS
{
    ...
    REST_NOSETACTIVEDESKTOP         = 0x4000001E,   // No Active desktop on NquKICseUFZOJGOCYlbsQNkxFBeSdv Menu
    REST_NOUPDATEWINDOWS            = 0x4000001F,   // No Windows Update on NquKICseUFZOJGOCYlbsQNkxFBeSdv Menu
    REST_NOCHANGESTARMENU           = 0x40000020,   // No Context menu or Drag and Drop on Start menu
    REST_NOFOLDEROPTIONS            = 0x40000021,   // No Folder Options on NquKICseUFZOJGOCYlbsQNkxFBeSdv Menu
    ...
    REST_NOCONTROLPANEL             = 0x40000027,   // Remove the Control Panel only from SM|NquKICseUFZOJGOCYlbsQNkxFBeSdv
    ...
    REST_NONETWORKCONNECTIONS       = 0x40000031,   // No Start Menu | NquKICseUFZOJGOCYlbsQNkxFBeSdv |Network Connections
...
//  Do NOT use me                     0x4000004B,
...
#endif  // NTDDI_WINXP
#if (NTDDI_VERSION >= NTDDI_WIN2KSP3)
    REST_NOSMCONFIGUREPROGRAMS      = 0x4000006F,   // No Configure Programs on NquKICseUFZOJGOCYlbsQNkxFBeSdv Menu
#endif  // NTDDI_WIN2KSP3
#if (NTDDI_VERSION >= NTDDI_WINXP)
    ...
    REST_NODISPSETTINGSPG           = 0x40000079,   // disables the NquKICseUFZOJGOCYlbsQNkxFBeSdv tab in the Display CPL
